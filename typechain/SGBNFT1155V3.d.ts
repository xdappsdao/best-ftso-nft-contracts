...
interface SGBNFT1155V3Interface extends ethers.utils.Interface {
  functions: {
  ...
  decodeFunctionResult(functionFragment: "fixRoyalty", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "getRoleAdmin",
    data: BytesLike
  ): Result;
...
export class SGBNFT1155V3 extends BaseContract {
  ...
  interface: SGBNFT1155V3Interface;
  ...
  callStatic: {
    ...
    fixRoyalty(overrides?: CallOverrides): Promise<void>;
